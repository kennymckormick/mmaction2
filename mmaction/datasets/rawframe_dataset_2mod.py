...
class RawframeDataset2Mod(BaseDataset):
    """Rawframe dataset for action recognition with 2 Modality.
    ...
    Args:
        ...
        filename_tmpl (str): Template for each filename.
            Default: '{}_{:05}.jpg'. Note: RGB: img_{:05d}.jpg,
            Flow: x/y_{:05d}.jpg
        ...
        modality (str): Modality of data. Support 'RGB', 'Flow'.
                            Default: 'RGBFlow' (since it's 2mod dataset).
    """
    ...
    def load_annotations(self):
        ...
        with open(self.ann_file, 'r') as fin:
            for line in fin:
                ...
                idx += 1
                video_info['flow_total_frames'] = int(line_split[idx])
                idx += 1
